 ...
 */
#define SET_UART1_WORD_LENGTH   UART_WORD_LENGTH_8_BIT
#define SET_UART2_WORD_LENGTH   UART_WORD_LENGTH_8_BIT
#define SET_UART3_WORD_LENGTH   UART_WORD_LENGTH_8_BIT
...
/**
 * @ref UART_INTERRUPT_CONFIG
 * @brief Enable or disable the interrupt of the UARTx
 *      possible values: @ref UART_INTERRUPT
 */
#define SET_UART1_INTERRUPT     UART_INTERRUPT_DISABLE
#define SET_UART2_INTERRUPT     UART_INTERRUPT_DISABLE
#define SET_UART3_INTERRUPT     UART_INTERRUPT_DISABLE

/**
 * @ref UART_SEND_RECEIVE_ENABLE_CONFIG
 * @brief Enable or disable the send and receive of the UARTx
 */
#define SET_UART1_SEND_RECEIVE_ENABLE     UART_SEND_RECEIVE_ENABLE
#define SET_UART2_SEND_RECEIVE_ENABLE     UART_SEND_RECEIVE_ENABLE
#define SET_UART3_SEND_RECEIVE_ENABLE     UART_SEND_RECEIVE_ENABLE

/**
 * @ref UART_REMAP_CONFIG
 * @brief Enable or disable the remap of the UARTx
 */
#define SET_UART1_REMAP     UART_NO_MAPPING
#define SET_UART2_REMAP     UART_NO_MAPPING
#define SET_UART3_REMAP     UART_NO_MAPPING
